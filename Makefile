...
push-ml-api-aws:
	docker push ${AWS_ECR_REGISTRY_ID}.dkr.ecr.us-east-1.amazonaws.com/udemy-ml-api

tag-ml-api-aws:
	docker tag udemy-ml-api:latest ${AWS_ECR_REGISTRY_ID}.dkr.ecr.us-east-1.amazonaws.com/udemy-ml-api:latest
